...
<div class="container">
    <div class="row d-flex justify-content-center mt-4">
        <div class="col-10 col-sm-9 col-md-7 col-lg-5">
            <div class="row d-flex justify-content-center align-items-center">
                ...
                <div class="col-10">
                    <h2 class="text-center"><small>Edit User</small></h2>
                </div>
                <div class="col-1">
                </div>
            </div>
    ...
    <div class="row d-flex justify-content-center mt-2">
        <div class="col-10 col-sm-9 col-md-7 col-lg-5">
            <form:form method="POST" modelAttribute="updateUserRequest" class="mt-3">
                ...
                <div class="form-group">
                    ...
                    <form:input class="form-control" path="dob" id="dob" placeholder="Select date" />
